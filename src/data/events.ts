...
export const CONFLICT_EVENTS: ConflictEvent[] = [
  ...
  { id: 'M-001', type: 'maritime', title: 'HORMUZ CLOSURE THREAT', time: '2026-03-01T08:00:00Z', lat: 26.5, lon: 56.3, description: 'IRGC Navy broadcasts Strait of Hormuz closure — mines detected in shipping lane' },
  ...
  { id: 'E-003', type: 'escalation', title: 'RUSSIA WARNS ESCALATION', time: '2026-03-02T10:00:00Z', lat: 55.75, lon: 37.62, description: 'Russian Foreign Ministry warns of "catastrophic consequences" — nuclear forces on alert' },
  ...
  { id: 'E-004', type: 'escalation', title: 'UN EMERGENCY SESSION', time: '2026-03-02T16:00:00Z', lat: 40.75, lon: -73.97, description: 'UN Security Council convenes emergency session — China and Russia block ceasefire resolution' },
];
